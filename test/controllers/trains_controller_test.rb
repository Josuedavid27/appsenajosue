...
class TrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create train" do
    assert_difference("Train.count") do
      post trains_url, params: { train: { nombre: @train.nombre, segundonombre: @train.segundonombre } }
    end
  ...
  test "should update train" do
    patch train_url(@train), params: { train: { nombre: @train.nombre, segundonombre: @train.segundonombre } }
