...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference("Computer.count") do
      post computers_url, params: { computer: { color: @computer.color, peso: @computer.peso } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { color: @computer.color, peso: @computer.peso } }
