class TrainsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to trains_path, status: :see_other, notice: "Train was successfully destroyed." }
  ...
  private
    ...
    def set_train
      @train = Train.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def train_params
      params.expect(train: [ :nombre, :segundonombre ])
    end
end
